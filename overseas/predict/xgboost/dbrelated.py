...
new_df=pd.read_csv('new_result_equal.csv',encoding='utf-8-sig')
yconnect=create_engine('mysql://root:950915@localhost:3306/application?charset=utf8')
pd.io.sql.to_sql(new_df,'new_result_equal',yconnect,schema='application',if_exists='append')
