...
conn=pymysql.connect(host='127.0.0.1',port=3306,user='root',passwd='pqw950915',db='application',charset='utf8')
new_df.to_sql('new_result_missing',conn,flavor='mysql')
conn.close()
print ('load done')
